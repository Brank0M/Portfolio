...
export default class Sketch {
	...
	//* Work on click events
	// addClickEvents() {
	// 	this.imageStore.forEach((i, index) => {
	// 		i.img.addEventListener("click", () => {
	// 			if (this.imageStore[index].selected) {
	// 				return;
	// 			}
	// 			this.imageStore.forEach((i) => {
	// 				i.mesh.material.uniforms.uCorners.value.set(0, 0, 0, 0);
	// 				i.selected = false;
	// 			});
	// 			this.imageStore[index].mesh.material.uniforms.uCorners.value.set(1, 1, 1, 1);
	// 			this.imageStore[index].selected = true;
	// 		});
	// 	});
	// }
	...
	resize() {
		...
		this.imageStore.forEach(i => {
			...
			i.mesh.material.uniforms.uQuadSize.value.x = this.width;
			i.mesh.material.uniforms.uQuadSize.value.y = this.height;

			i.mesh.material.uniforms.uTextureSize.value.x = this.width;
			i.mesh.material.uniforms.uTextureSize.value.y = this.height;
		})
	}
